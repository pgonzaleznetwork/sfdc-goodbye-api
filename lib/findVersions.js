...
async function findVersions(connection){
    ...
    const totalLogsCsv = convertArrayToCSV(totalLogs,
        {header:getTotalUsageHeader(),
        separator: ''}
    );
    ...
    fs.writeFileSync('results/totalUseLogs.csv', totalLogsCsv);
